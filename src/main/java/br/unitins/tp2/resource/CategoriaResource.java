...
public class CategoriaResource {
    ...
    public Response buscarTodos(@QueryParam("page") @DefaultValue("0") int page,
        ...
        List<CategoriaResponseDTO> lista = service.findAll(page, pageSize);
    ...
    public Response incluir(@Valid CategoriaDTO dto) {
        CategoriaResponseDTO criada = service.create(dto);
        URI location = UriBuilder.fromResource(CategoriaResource.class)
                .path("{id}")
                .build(criada.id());
