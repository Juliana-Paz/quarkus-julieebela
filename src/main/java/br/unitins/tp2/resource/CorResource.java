...
public class CorResource {
    ...
    @POST
    @RolesAllowed("Adm")
    public Response incluir(@Valid CorDTO dto) {
        CorResponseDTO criada = service.create(dto);
        URI location = UriBuilder.fromResource(CorResource.class)
                .path("{id}")
                .build(criada.id());
    ...
    @Path("/{id: \\d+}")
    @RolesAllowed("Adm")
    public Response alterar(@PathParam("id") Long id, @Valid CorDTO dto) {
